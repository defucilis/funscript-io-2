...
export interface FunHalverOptions {
 ...
 * @param  {FunHalverOptions} options - Options to change the behaviour of the speed-halving
 */
export const getHalfSpeedGroup = (actionGroup: Action[], options: FunHalverOptions): Action[] => {
 ...
 * @param  {FunHalverOptions} options - Options to configure how the halving is done
 * @returns The half-speed funscript
 */
export const getHalfSpeedScript = (script: Funscript, options: FunHalverOptions): Funscript => {
